...
*/
    ...
    let url = 'https://sipcityapi.mobileprogramming.net/merchant-signup';
    let h = new Headers();
  ...
  return (
    <div className='containeradd'>
      <Row >
        <Col class='col-sm-4' >
      <div >
      <img src={newlogo} className='imageadd' height="" alt="login" />
      </div>
      </Col>
      <Col>
      <div style={{ backgroundColor: 'Red'}}>
  <div className="AddMerchantmain AddMerchantmainnew"><h3 className="AddMerchantHeading">Merchant Signup</h3><br />
    {/* <h6 className="HeadingBottom">Please enter Basic Info</h6> */}

    <Form onSubmit={postData} id="myForm" style={{ backgroundColor: ''}} >
      <Form.Row>
        <Col xs={5}>
      ...
      <Form.Row>
        <Col xs={3}>
          <Form.Group controlId="working_hours_lunch">
            <Form.Label className="label">Working Hours </Form.Label><br />
      ...
      <Form.Row>
        <Form.Group controlId="restaurant_image">
          <label name="Add Images" value={state.restaurant_image} className="label" >Add Restaurant Images(Maximum of 5)</label>
      ...
      <Form.Row>
        ...
        <Form.Group controlId="menu_image">
          <label name="menu_image" className="label">Add Menu Images(Maximum of 5)</label>
          <Box display="flex" flexwrap="true">
